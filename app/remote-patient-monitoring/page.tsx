...
import DecreaseWorkload from '../../public/images/decrease-workload.jpg';
    ...
    <div>
      <section className="inner-hero-section">
        ...
        <div className="inner-hero-content">
          ...
          <h2 className="heading text-left">Remote Patient Monitoring</h2>
        </div>
      </section>
      ...
      <section className='section-card counter-section relative z-1'>
        ...
        <ul className='flex flex-wrap'>
          <li className='text-left p-5 w-full xs:w-1/2 lg:w-1/4' data-aos="fade-up" data-aos-duration="500" data-aos-delay="0">
            ...
            <div>
              <p className='counter-text'>Hypertensive patients reduced systolic blood pressure by 11 points</p>
            </div>
          </li>
          <li className='text-left p-5 w-full xs:w-1/2 lg:w-1/4' data-aos="fade-up" data-aos-duration="500" data-aos-delay="250">
            <div className='relative inline-block'>
              <p className='counter-number'>-4.5</p>
            </div>
            <div className='mt-5 mb-5 md:mr-35 xl:mr-70 border-b bg-[#c9cdcf]'></div>
            <div>
              <p className='counter-text'>Drop in A1C for diabetic patients</p>
            </div>
          </li>
          <li className='text-left p-5 w-full xs:w-1/2 lg:w-1/4' data-aos="fade-up" data-aos-duration="500" data-aos-delay="500">
            <div className='relative inline-block'>
              <p className='counter-number'>92%</p>
            </div>
            <div className='mt-5 mb-5 md:mr-35 xl:mr-70 border-b bg-[#c9cdcf]'></div>
            <div>
              <p className='counter-text'>Patient adherence rate</p>
            </div>
          </li>
          <li className='text-left p-5 w-full xs:w-1/2 lg:w-1/4' data-aos="fade-up" data-aos-duration="500" data-aos-delay="750">
            <div className='relative inline-block'>
              <p className='counter-number'>30%</p>
            </div>
            <div className='mt-5 mb-5 md:mr-35 xl:mr-70 border-b bg-[#c9cdcf]'></div>
            <div>
              <p className='counter-text'>Reduction in ED visits</p>
            </div>
          </li>
        </ul>
      ...
      <div className='main-grid-container'>
        <section className='grid-section !mt-10' data-aos="fade-up" data-aos-duration="500">
          ...
          <div className='inner-grid'>
            <div data-aos="fade-right" data-aos-duration="500" data-aos-delay="250">
              <h3 className='grid-heading'>Drive better patient outcomes.</h3>
              <p className='grid-text'>Remote patient monitoring is the key to complete visibility. Treating chronic disease patients is for a lifetime. The more information you have, the better decisions you can make about care plans. Remote monitoring is a safety net for at-risk patients. RPM expands care beyond the office visit and is a critical component in achieving better patient outcomes.</p>
            </div>
            <div data-aos="fade-left" data-aos-duration="500" data-aos-delay="250">
              <Image src={PatientOutcomes} alt={''} />
            </div>
          </div>
        </section>
        <section className='grid-section' data-aos="fade-up" data-aos-duration="500">
          ...
          <div className='inner-grid'>
            <div data-aos="fade-right" data-aos-duration="500" data-aos-delay="250">
              <Image src={PatientExp} alt={''} />
            </div>
            <div data-aos="fade-left" data-aos-duration="500" data-aos-delay="250">
              <h3 className='grid-heading'>Modernize the patient experience.</h3>
              <p className='grid-text'>Patient experience is critical in ensuring the best clinical outcomes. With RPM software, you can modernize care with the power of technology that delivers valuable data conveniently. RPM enables healthcare providers to tailor treatment plans based on real-time patient data, leading to more personalized and effective care.</p>
            </div>
          </div>
        </section>
        <section className='grid-section' data-aos="fade-up" data-aos-duration="500">
          ...
          <div className='inner-grid'>
            <div data-aos="fade-right" data-aos-duration="500" data-aos-delay="250">
              <h3 className='grid-heading'>Improve patient engagement.</h3>
              <p className='grid-text'>Increasing patient engagement is a challenge for any practice. Practices that have initiated our RPM software are more actively tracking vitals and increasing touchpoints beyond transactional interactions. The Optimize Health clinical team acts as an extension to your staff and creates access for your patients without demanding more time from your team. Patients who have found it challenging to keep up with frequent follow-ups and complex treatment regimens now have easier ways to engage in their health.</p>
            </div>
            <div data-aos="fade-left" data-aos-duration="500" data-aos-delay="250">
              <Image src={PatientEngage} alt={''} />
            </div>
          </div>
        </section>
        <section className='grid-section' data-aos="fade-up" data-aos-duration="500">
          ...
          <div className='inner-grid'>
            <div data-aos="fade-right" data-aos-duration="500" data-aos-delay="250">
              <Image src={DecreaseWorkload} alt={''} />
            </div>
            <div data-aos="fade-left" data-aos-duration="500" data-aos-delay="250">
              <h3 className='grid-heading'>Decrease workload.</h3>
              <p className='grid-text'>There’s never enough time in the day to cover every patient, and increasing touchpoints is something you want to do, but not at the expense of your staff. The last thing you or they want to do is spend more time on technology. Optimize Health’s RPM program includes user-friendly software that syncs data from connected devices to patient records. Our clinical team is an extension of your staff, escalating only those who need you now. 1%-2% of Optimize Health alerts require escalation to your clinical team. It streamlines workflows, ensures patients get the attention they need, and decreases your clinical staff’s workload.</p>
            </div>
          </div>
        </section>
        <section className='grid-section' data-aos="fade-up" data-aos-duration="500">
          ...
          <div className='inner-grid'>
            <div data-aos="fade-right" data-aos-duration="500" data-aos-delay="250">
              <h3 className='grid-heading'>Increase revenue with an RPM program.</h3>
              <p className='grid-text'>Remote patient monitoring supports fee-for-service and value-based care incentives. RPM programs can improve the quality of care through outcomes like reduced hospitalization, readmission, and HbA1c numbers. Our platform includes clinical and billing workflows, as well as support in dealing with private insurance, Medicare, and Medicaid.</p>
            </div>
            <div data-aos="fade-left" data-aos-duration="500" data-aos-delay="250">
              <Image src={RPMProgram} alt={''} />
            </div>
          </div>
        </section>
      </div>
