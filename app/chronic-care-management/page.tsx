...
import PatientPartnerImg from '../../public/images/boost-partnership.png';
import StreamCare from '../../public/images/streamline-care-management.jpg';
import CustomCCM from '../../public/images/custom-ccm-solution.jpg';
import OptimizeCCM from '../../public/images/optimize-ccm-outcomes.jpg';
import ScaleCCM from '../../public/images/scale-ccm.jpg';
import GrowCCM from '../../public/images/grow-ccm-revenue.jpg';
        ...
        <div>
            <section className="inner-hero-section">
                ...
                <div className="position-relative">
                    <Image src={CCMIMage} className="hero-banner" alt="AvatarX Health" />
                    <svg
                ...
                <div className="inner-hero-content">
                    <h4 className="eyebrow-heading text-left">Patient Care</h4>
                    <h2 className="heading text-left">Chronic Care Management</h2>
                </div>
            </section>
            <section className="ccm-content">
                <div className='grid-content'>
                    <div className='lg:w-4/5'>
                        <h2 className='section-heading' data-aos="fade-up" data-aos-duration="500">Treat vulnerable patients holistically with chronic care management.</h2>
                    </div>
                ...
                <div className='grid-content justify-content-end mt-10'>
                    ...
                    <div className='lg:w-2/3 text-left'>
                        <p className='section-text' data-aos="fade-up" data-aos-duration="500">Apply a multi-dimensional, coordinated, and comprehensive CCM solution for at-risk patients.</p>
                        <button className='cta-button' onClick={() =>
                            router.push(
                                "https://calendly.com/phanig/30-minute?month=2025-02"
                            )} data-aos="fade-up" data-aos-duration="500">Request a consultation</button>
                    </div>
                </div>
            </section>
            <section className='section-card relative z-1'>
                <h2 className='section-heading relative z-1' data-aos="fade-up" data-aos-duration="500">How chronic care management delivers better clinical outcomes.</h2>
            ...
            <div className='main-grid-container'>
                <section className='grid-section !mt-10' data-aos="fade-up" data-aos-duration="500">
                    ...
                    <div className='inner-grid'>
                        <div data-aos="fade-right" data-aos-duration="500" data-aos-delay="250">
                            <h3 className='grid-heading'>Boost patient participation and engagement.</h3>
                            <p className='grid-text'>Better outcomes follow when patients engage with clinicians and are part of the care plan. The key is consistent monthly touchpoints of at least 20 minutes, which our CCM platform makes easy with built-in communication tools and trackability of engagement time. Those check-ins can include care plans, prescriptions, chart reviews, appointment scheduling, and referral discussions These CCM activities integrate into your existing workflows. Our U.S.-based chronic care managers are an extension of your staff, ensuring care continuity. Patients get the encouragement and attention they need with a seamless experience.</p>
                        </div>
                        <div data-aos="fade-left" data-aos-duration="500" data-aos-delay="250">
                            <Image src={PatientPartnerImg} alt={''} />
                        </div>
                    </div>
                </section>
                <section className='grid-section' data-aos="fade-up" data-aos-duration="500">
                    ...
                    <div className='inner-grid'>
                        <div data-aos="fade-right" data-aos-duration="500" data-aos-delay="250">
                            <Image src={StreamCare} alt={''} />
                        </div>
                        <div data-aos="fade-left" data-aos-duration="500" data-aos-delay="250">
                            <h3 className='grid-heading'>Streamline care management in one place.</h3>
                            <p className='grid-text'>Using our CCM solution, management of all processes occurs in one platform. With intuitive technology, you have the features to streamline care management with automatic time tracking. Our solution facilitates all the requirements for chronic care management, starting with acquiring and documenting patient consent. You then submit the care plan in the platform and begin managing it. As a managed service, we provide chronic care managers to connect with patients regularly to address problems, goals, and next steps.</p>
                        </div>
                    </div>
                </section>
                <section className='grid-section' data-aos="fade-up" data-aos-duration="500">
                    ...
                    <div className='inner-grid'>
                        <div data-aos="fade-right" data-aos-duration="500" data-aos-delay="250">
                            <h3 className='grid-heading'>Create a custom CCM solution to align with your specialty and patient population.</h3>
                            <p className='grid-text'>Every practice and its patients are unique, so it’s essential to partner with a CCM company that builds a program based on these needs. Our CCM program enables you to develop individual care plans with goals, barriers, symptoms, problems, medications, and allergies.</p>
                        </div>
                        <div data-aos="fade-left" data-aos-duration="500" data-aos-delay="250">
                            <Image src={CustomCCM} alt={''} />
                        </div>
                    </div>
                </section>
                <section className='grid-section' data-aos="fade-up" data-aos-duration="500">
                    ...
                    <div className='inner-grid'>
                        <div data-aos="fade-right" data-aos-duration="500" data-aos-delay="250">
                            <Image src={OptimizeCCM} alt={''} />
                        </div>
                        <div data-aos="fade-left" data-aos-duration="500" data-aos-delay="250">
                            <h3 className='grid-heading'>Optimize CCM outcomes with greater visibility by monitoring adherence and results.</h3>
                            <p className='grid-text'>Chronic condition patients typically need more encounters than those in clinic. With accurate and timely insights into their day-to-day life of managing a chronic disease, you can make data-driven decisions about care plans and track progress against goals.</p>
                        </div>
                    </div>
                </section>
                <section className='grid-section' data-aos="fade-up" data-aos-duration="500">
                    ...
                    <div className='inner-grid'>
                        <div data-aos="fade-right" data-aos-duration="500" data-aos-delay="250">
                            <h3 className='grid-heading'>Implement and scale CCM with easy software and managed services.</h3>
                            <p className='grid-text'>Growing and administering CCM programs doesn’t require strain on your internal team. With innovative technology and managed services, building and scaling CCM is not a challenge. As a managed service, CCM includes our U.S.-based, chronic care management as an extension of your staff. They can enroll and educate patients and conduct encounters. The system captures and transmits data and information to your EHR. Our platform also handles all the administrative work of managing care plans, as CMS requires. Your program will flourish without demanding time that keeps you away from patient care.</p>
                        </div>
                        <div data-aos="fade-left" data-aos-duration="500" data-aos-delay="250">
                            <Image src={ScaleCCM} alt={''} />
                        </div>
                    </div>
                </section>
                <section className='grid-section' data-aos="fade-up" data-aos-duration="500">
                    ...
                    <div className='inner-grid'>
                        <div data-aos="fade-right" data-aos-duration="500" data-aos-delay="250">
                            <Image src={GrowCCM} alt={''} />
                        </div>
                        <div data-aos="fade-left" data-aos-duration="500" data-aos-delay="250">
                            <h3 className='grid-heading'>Grow CCM revenue and operational efficiency.</h3>
                            <p className='grid-text'>CCM reimbursement requires time tracking and applying proper codes. Our software includes revenue functionality to cover these actions. With a connected platform that simplifies claims and billing, you also achieve operational efficiency, as the built-in billing eliminates hours of manual work.</p>
                        </div>
                    </div>
                </section>
            </div>
            <section className='steps-section'>
                <h2 className='section-heading' data-aos="fade-up" data-aos-duration="500">What are the steps of creating a CCM program?</h2>
                <div className='inner-steps'>
                    <div className='step-card'>
                        <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="0">
                            <div className='step-card-img'>
                                <Image src={PatientFit} alt={''} />
                                <span className='step-number'>1</span>
                            </div>
                            <p>Determine which patients fit the criteria.</p>
                        </div>
                    </div>
                    <div className='step-card'>
                        <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="250">
                            <div className='step-card-img'>
                                <Image src={PatientComplaint} alt={''} />
                                <span className='step-number'>2</span>
                            </div>
                            <p>Enroll patients in a compliant, secure workflow.</p>
                        </div>
                    </div>
                    <div className='step-card !border-e-0'>
                        <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="500">
                            <div className='step-card-img'>
                                <Image src={CarePlans} alt={''} />
                                <span className='step-number'>3</span>
                            </div>
                            <p>Create care plans.</p>
                        </div>
                    </div>
                    <div className='step-card lg:!border-b-0'>
                        <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="250">
                            <div className='step-card-img'>
                                <Image src={ClinicDirected} alt={''} />
                                <span className='step-number'>4</span>
                            </div>
                            <p>Deliver clinician-directed interactions with patients.</p>
                        </div>
                    </div>
                    <div className='step-card lg:!border-b-0'>
                        <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="500">
                            <div className='step-card-img'>
                                <Image src={CareCoordinate} alt={''} />
                                <span className='step-number'>5</span>
                            </div>
                            <p>Track time related to care coordination and physician care.</p>
                        </div>
                    </div>
                    <div className='step-card !border-b-0 !border-e-0'>
                        <div data-aos="fade-up" data-aos-duration="500" data-aos-delay="750">
                            <div className='step-card-img'>
                                <Image src={ClaimsCMS} alt={''} />
